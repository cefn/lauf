 ...
 * @param messageBacklog Maximum backlog of waiting messages before [[MessageQueue.send]] returns `false`
 * @param receiverBacklog Maximum backlog of waiting receivers before [[MessageQueue.receive]] throws an Error
